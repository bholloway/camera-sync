    ...
    Promise.resolve(args)
      ...
      .then(lens({from: 'plan', to: 'sync'})(
        lens({from: 'pending', to: 'errors', label: '*'})(
          compose(
            map(({source, destination, checksum, birthtimeMs}) =>
              Promise.resolve()
                .then(() =>
                ...
                .then(() =>
                  promisify(utimes)(destination, birthtimeMs, undefined, undefined)
                ...
                .then(() => Promise.all([
                  ...
                  promisify(stat)(destination)
                    .then(({birthtimeMs: actualBtime}) =>
                      (actualBtime !== birthtimeMs) && Promise.reject(new Error('btime'))
                    )
                ]))
                .then(() => false)
